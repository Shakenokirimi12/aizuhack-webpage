const AizuHackAdvanced = () => {
  const ArrowRight = () => (
    <div className="hidden md:flex items-center justify-center">
      <svg className="w-8 h-8 text-[#005555]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <main className="w-full pt-24 pb-16">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center py-16 bg-white rounded-lg shadow-lg mb-16">
            <span className="text-base text-gray-600 block mb-2">経験者向け</span>
          ...
          <section className="bg-white rounded-lg shadow-lg p-8 mb-12">
            ...
            <div className="flex flex-col md:flex-row items-stretch gap-4 md:gap-8 mb-8">
              <div className="p-6 border-2 border-[#005555] rounded-lg flex-1">
                ...
                <p className="text-gray-600">
                  テーマと審査基準をもとに、チームでアイデアを練り上げます。<br/>
                  高度な技術スタックの選定と<br/>
                  実装計画の立案を行います。
                </p>
              </div>
            ...
            <div className="bg-gray-50 p-4 rounded-lg">
              <p className="text-gray-600 text-sm">
                ※ Hack Dayまでの期間は、開発作業は禁止となっています。<br/>
          ...
          <section className="bg-white rounded-lg shadow-lg p-8 mb-12">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="p-6 border-2 border-[#005555]/20 rounded-lg">
                ...
                <p className="text-gray-600">
                  会津大学の強みである学生の高い技術力を活かし、<br/>
                  より挑戦的な課題に取り組むことができます。<br/>
                  企業からの技術メンタリングも提供されます。
                </p>
              </div>
              <div className="p-6 border-2 border-[#005555]/20 rounded-lg">
                <h3 className="text-xl font-semibold text-[#005555] mb-3">
          ...
          <section className="bg-white rounded-lg shadow-lg p-8">
            ...
            <div className="text-center">
              ...
              <button className="bg-[#005555] text-white px-8 py-3 rounded-full text-lg font-semibold hover:bg-[#004444] transition-colors disabled:opacity-50" disabled>
                Coming Soon
              </button>
            </div>
          </section>
