    ...
    <nav className="w-full bg-white shadow-md py-4 px-6 fixed top-0 z-50">
      <div className="max-w-7xl mx-auto flex items-center">
        ...
        <div className="w-64">
          <Link
            to="/"
            className={`text-2xl font-bold relative h-8 block overflow-hidden min-w-[160px] ${
              re ? "text-[#005555]" : "text-[#009999]"
            }`}
          >
            <span
              className={`absolute top-0 left-0 w-full transition-transform duration-500 ${
                re ? "-translate-y-full" : "translate-y-0"
              }`}
            >
              AizuHack
            </span>
            <span
              className={`absolute top-0 left-0 w-full transition-transform duration-500 ${
                re ? "translate-y-0" : "translate-y-full"
              }`}
            >
              Re:AizuHack
            </span>
        ...
        <div className="flex-1 hidden md:flex justify-center space-x-6">
          <Link
            to="/en/aizu-hack-2025"
            className="text-[#009999] hover:text-gray-600 whitespace-nowrap"
          >
            AizuHack (For Beginners)
          </Link>
          <Link
            to="/en/re-aizu-hack-2025"
            className="text-[#009999] hover:text-gray-600 whitespace-nowrap"
          >
        ...
        <div className="w-64 flex justify-end items-center">
          <button onClick={toggleLanguage} className="mr-4">
            <svg
              ...
              className="h-6 w-6 text-[#009999] hover:text-gray-600"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
            >
              <path
                ...
                strokeWidth={2}
                d="M12 11c0 4.418-3.582 8-8 8M20 19c-4.418 0-8-3.582-8-8M4 11c0-4.418 3.582-8 8-8m0 0c4.418 0 8 3.582 8 8"
              />
            </svg>
          </button>
