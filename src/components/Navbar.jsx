    ...
    <nav className="w-full bg-white shadow-md py-4 px-6 fixed top-0 z-50">
      <div className="max-w-7xl mx-auto flex items-center">
        ...
        <div className="flex-1 hidden md:flex justify-center space-x-6">
          <Link to="/ja/aizu-hack-2025" className="text-[#009999] hover:text-gray-600 whitespace-nowrap">
            AizuHack(初心者向け)
          </Link>
          <Link to="/ja/re-aizu-hack-2025" className="text-[#009999] hover:text-gray-600 whitespace-nowrap">
            Re:AizuHack(経験者向け)
          </Link>
          <Link to="/ja/mentors" className="text-[#009999] hover:text-gray-600 whitespace-nowrap">
            メンター
          </Link>
          <Link to="/ja/faq" className="text-[#009999] hover:text-gray-600 whitespace-nowrap">
            FAQ
          </Link>
        </div>
